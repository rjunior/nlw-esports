        ...
        <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <Select.Root name='game'>
              <Select.Trigger 
                className='flex flex-row justify-between items-center bg-zinc-900 py-3 px-4 rounded text-sm cursor-default'
              >
              ...
              <Select.Portal 
                className='bg-zinc-900 py-3 pl-4 text-sm rounded cursor-default'
              >
                <Select.Content 
                  ...
                  <Select.Viewport>
                    { games.map(game => {
                      return (
                        <Select.Item 
                          key={game.id}
                          className='focus-within:bg-violet-500 select-none'
                          value={game.id}
                        >
